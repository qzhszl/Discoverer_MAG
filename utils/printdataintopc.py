...
def print_basic_statistics_into_pc():
    ...
    # data = open("Discoverer.txt", "w+")
    # for j in range(len(DI)):
    #     print(DI[j], file=data)
    # data.close()
    #
    # data = open("Coauthor.txt", "w+")
    # for j in range(len(KI)):
    #     print(KI[j], file=data)
    # data.close()

    data = open("Surprisal.txt", "w+")
    for j in range(len(SI)):
        print(SI[j], file=data)
    data.close()

    # data = open("Citation.txt", "w+")
...
def print_bsur_into_pc():
    ...
    data = open("Bsur.txt", "w+")
    for j in range(len(DI)):
        print(DI[j], file=data)
    data.close()

    data = open("Ifdis.txt", "w+")
    for j in range(len(KI)):
        print(KI[j], file=data)
    data.close()

    data = open("Iftop.txt", "w+")
    for j in range(len(SI)):
        print(SI[j], file=data)
    data.close()
...
if __name__ == '__main__':
    print_basic_statistics_into_pc()